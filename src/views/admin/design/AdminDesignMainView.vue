	...
	<main id="contents" class="content">
		...
		<script type="text/javascript">
			...
			function openMovie(idx) {
				$.laybox({
					type: 'iframe',
					source: 'main_movie_ifrm?idx=' + idx,
				});
			}

			function manageGoods(idx) {
				location.href = 'main_goods?main=' + idx;
			}

			function manageBanner(idx) {
				location.href = 'main_banner?main=' + idx;
			}
			...
			function save() {
				...
				if (confirm('설정 내역으로 적용하시겠습니까?')) {
					...
					$(f.displayChk).each(function () {
						...
						if (areaKind === 'TOP') {
							topDisplay[$(this).attr('code')] = $(this).is(':checked')
								? 'T'
								: 'F';
						} else if (areaKind === 'MAIN') {
							...
							<table>
								...
								<tbody>
									<tr class="movable">
										<td class="mover">
											<div class="namebox">
												<input type="hidden" name="idxList" value="30" />
												<label
													><input
														type="checkbox"
														name="displayChk"
													...
													/>선택</label
												>
												<input type="text" name="areaName" value="메인비쥬얼" />
												<button
													type="button"
													class="btn_sec md button"
													onclick="goToDetail('MAIN','30')"
												>
													수정
												</button>
											</div>
							...
							<table>
								...
								<tbody>
									<tr class="movable">
										<td class="mover">
											<div class="namebox">
												<input type="hidden" name="idxList" value="68" />
												<label
													><input
														type="checkbox"
														name="displayChk"
													...
													/>선택</label
												>
												<input type="text" name="areaName" value="브랜드" />
												<button
													type="button"
													class="btn_sec md button"
													onclick="goToDetail('MAIN','68')"
												>
													수정
												</button>
											</div>
							...
							<table>
								...
								<tbody>
									<tr class="movable">
										<td class="mover">
											<div class="namebox">
												<input type="hidden" name="idxList" value="33" />
												<label
													><input
														type="checkbox"
														name="displayChk"
													...
													/>선택</label
												>
												<input type="text" name="areaName" value="베스트" />
												<button
													type="button"
													class="btn_sec md button"
													onclick="goToDetail('MAIN','33')"
												>
													수정
												</button>
											</div>
							...
							<table>
								...
								<tbody>
									<tr class="movable">
										<td class="mover">
											<div class="namebox">
												<input type="hidden" name="idxList" value="69" />
												<label
													><input
														type="checkbox"
														name="displayChk"
													...
													/>선택</label
												>
												<input type="text" name="areaName" value="신상품" />
												<button
													type="button"
													class="btn_sec md button"
													onclick="goToDetail('MAIN','69')"
												>
													수정
												</button>
											</div>
							...
							<table>
								...
								<tbody>
									<tr class="movable">
										<td class="mover">
											<div class="namebox">
												<input type="hidden" name="idxList" value="32" />
												<label
													><input
														type="checkbox"
														name="displayChk"
							...
							<table>
								...
								<tbody>
									<tr class="movable">
										<td class="mover">
											<div class="namebox">
												<input type="hidden" name="idxList" value="37" />
												<label
													><input
														type="checkbox"
														name="displayChk"
							...
							<table>
								...
								<tbody>
									<tr class="movable">
										<td class="mover">
											<div class="namebox">
												<input type="hidden" name="idxList" value="34" />
												<label
													><input
														type="checkbox"
														name="displayChk"
