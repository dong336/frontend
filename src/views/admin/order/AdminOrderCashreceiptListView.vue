	...
	<main id="contents" class="content">
		...
		<script type="text/javascript">
			...
			function openDealProof(idx) {
				openPopup(
					'../../common/dealproof/cashreceipt_print_pop?idx=' + idx,
					'DealProof',
					390,
					710,
					'scrollbars=yes',
			...
			function downExcel() {
				frmProc.location.replace(
					'cashreceipt_list_excel?sissue=&sdts=&sdte=&skey=&sword=',
				);
			}
		...
		<div class="main_content">
			...
			<section class="cont_wrap">
				<div class="section_head">
					<h4 class="total">총 <strong>0</strong>건이 조회 되었습니다.</h4>
				</div>
				...
				<form name="Frm" method="post">
					...
					>
						...
						<tbody>
							<tr>
								<td height="50" colspan="11">조회된 정보가 없습니다.</td>
							</tr>
						</tbody>
					</table>
						...
						<dl>
							...
							<dd>
								...
								<select id="batchState" name="batchState">
									<option value="">선택</option>
									<option value="100">발급신청</option>
									<option value="900">발급완료</option></select
								>로(으로)
								<button
									type="button"
									onclick="setStateList()"
									class="btn_sec md"
								>
									수정하기
								</button>
