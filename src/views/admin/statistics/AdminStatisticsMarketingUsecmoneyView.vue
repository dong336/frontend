<template>
	<main id="contents" class="content">
		...
		<ul class="helpbox">
			<li>
				아래의 통계는 <span class="red">배송완료</span>기준의 통계 입니다.
			</li>
			<li>
				판매금액은 배송완료된 주문의 주문금액[(판매가+옵션가)×수량]으로써
		...
		<div class="main_content">
			...
			<section class="cont_wrap">
				<div class="section_head">
					...
					<div>
						<a
							href="marketing_usecmoney_excel?sdate=2023-09-01&amp;edate=2023-09-07"
							class="btn_sec md"
							>엑셀로받기</a
						>
					</div>
