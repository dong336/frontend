...
var _nhnSe2 = {
	...
	setContents: function (winName) {
		if (winName) {
			...
			NHN_SE2_EDITORS.getById[arrWn[arrWn.length - 1]].exec(
...
nhn.husky.EZCreator = new (function () {
	...
	this.createInIFrame = function (htOptions) {
		...
		if (this.sEditorPath) {
			this.sEditorPath = this.sEditorPath
				.substring(0, this.sEditorPath.lastIndexOf('/'))
				.replace('/js', '');
		}
		...
		var sSkinURI =
			htOptions.sSkinURI || this.sEditorPath + '/SmartEditor2Skin.html';
