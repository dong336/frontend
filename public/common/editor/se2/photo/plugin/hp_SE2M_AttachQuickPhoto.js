...
nhn.husky.SE2M_AttachQuickPhoto = jindo.$Class({
	...
	$init: function (oAppContainer, bUseAttachPhoto) {
		if (typeof bUseAttachPhoto == 'undefined' || bUseAttachPhoto === true) {
			jindo.$$.getSingle(
				'LI.husky_seditor_ui_photo_attach',
				oAppContainer,
			).style.display = 'block';
		}
	},
	...
	$ON_ATTACHPHOTO_OPEN_WINDOW: function () {
		...
		this.htPopupOption.sProperties =
			'left=0,top=0,width=380,height=315,scrollbars=no,location=no,status=0,resizable=no';
	...
	makePopupURL: function () {
		var sPopupUrl = './photo/photo_uploader'; // html5 업로드
