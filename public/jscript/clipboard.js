...
function fnCopyClipboard(){
	...
	$('#btnClipboard').attr("data-clipboard-text",location.href);
	$('#btnClipboard').click();
	alert("주소가 복사되었습니다.");
}

<div style="display:none;">
	<button class="btn" id="btnClipboard" data-clipboard-text="">
	</button>
</div>
 */
(function (f) {
			...
			6: [
				function (require, module, exports) {
					...
					var ClipboardAction = (function () {
						...
						ClipboardAction.prototype.handleResult = function handleResult(
							succeeded,
						) {
							if (succeeded) {
			...
			7: [
				function (require, module, exports) {
					...
					var Clipboard = (function (_Emitter) {
						...
						Clipboard.prototype.delegateClick = function delegateClick(
							selector,
						) {
							var _this = this;

							this.binding = _delegateEvents2['default'].bind(
								document.body,
								selector,
								'click',
								function (e) {
						...
						Clipboard.prototype.undelegateClick = function undelegateClick() {
							_delegateEvents2['default'].unbind(
								document.body,
								'click',
								this.binding,
							);
						...
						Clipboard.prototype.defaultAction = function defaultAction(
							trigger,
						) {
						...
						Clipboard.prototype.defaultTarget = function defaultTarget(
							trigger,
						) {
