function loadSwf(sUrl, sWidth, sHeight, sId, sAlign, sBgcolor, sWmode) {
	...
	var html =
		'' +
		'<object classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000" codebase="http://fpdownload.macromedia.com/get/flashplayer/current/swflash.cab" id="' +
		sId +
		'"' +
		(sWidth != '' ? ' width="' + sWidth + '"' : '') +
		...
		'" wmode="' +
		sWmode +
		'" allowScriptAccess="always" swLiveConnect="true" type="application/x-shockwave-flash" pluginspage="http://www.macromedia.com/go/getflashplayer" />\n' +
		'</object>\n';
...
function loadMov(sUrl, sWidth, sHeight, sId, sAutoStart, sAutoSize) {
	...
	var html =
		'' +
		'<object classid=CLSID:22d6f312-b0f6-11d0-94ab-0080c74c7e95 codebase=http://activex.microsoft.com/activex/controls/mplayer/en/nsmp2inf.cab#Version=6,0,5,0803 type=application/x-oleobject' +
		(sWidth != '' ? ' width="' + sWidth + '"' : '') +
		(sHeight != '' ? ' height="' + sHeight + '"' : '') +
		' standby=Loading Windows Media Player components... id="' +
		sId +
		'">' +
